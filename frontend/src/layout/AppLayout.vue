...
const menuItems = [
  ...
  },
  {
    ...
    icon: 'Box',
    children: [
      { path: '/containers/k8s/clusters', title: '集群管理', icon: 'OfficeBuilding', permission: 'ops.k8s.view' },
      { path: '/containers/k8s/nodes', title: '节点管理', icon: 'Monitor', permission: 'ops.k8s.view' },
      { path: '/containers/k8s/workspaces', title: '企业空间', icon: 'Grid', permission: 'ops.k8s.workspace.view' },
      { path: '/containers/k8s/projects', title: '项目管理', icon: 'Files', permission: 'ops.k8s.project.view' },
      { path: '/containers/k8s/namespaces', title: '命名空间', icon: 'FolderOpened', permission: 'ops.k8s.view' },
      { path: '/containers/k8s/workloads', title: '工作负载', icon: 'Cpu', permission: 'ops.k8s.view' },
      { path: '/containers/k8s/pods', title: 'Pod 管理', icon: 'Box', permission: 'ops.k8s.view' },
      { path: '/containers/k8s/network', title: '网络管理', icon: 'Connection', permission: 'ops.k8s.view' },
      { path: '/containers/k8s/storage', title: '存储管理', icon: 'Coin', permission: 'ops.k8s.view' },
      { path: '/containers/k8s/configs', title: '配置管理', icon: 'Setting', permission: 'ops.k8s.view' },
