PERMISSION_DEFINITIONS = [
    ...
    ('ops.k8s.workspace.view', '查看 K8s 企业空间', 'ops', '查看企业空间及其成员，非管理员仅可见自己所属的空间'),
    ('ops.k8s.workspace.manage', '管理 K8s 企业空间', 'ops', '创建、编辑、删除企业空间并维护成员'),
    ('ops.k8s.project.view', '查看 K8s 项目', 'ops', '查看项目、配额与命名空间用量，非管理员仅可见自己所属的项目'),
    ('ops.k8s.project.manage', '管理 K8s 项目', 'ops', '创建、纳管、解绑项目并维护配额与成员'),
...
BUILTIN_ROLES = [
    ...
    },
    {
        ...
        'permissions': [
            ...
            'ops.k8s.workspace.view', 'ops.k8s.workspace.manage', 'ops.k8s.project.view', 'ops.k8s.project.manage',
    ...
    },
    {
        ...
        'permissions': [
            ...
            'ops.k8s.workspace.view', 'ops.k8s.project.view',
